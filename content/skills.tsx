...
const skills: Skill[] = [
  ...
  { title: 'SASS', image: '/skills/sass.png', proficiency: 3 },
  { title: 'JAVASCRIPT', image: '/skills/js.png', proficiency: 4 },
  { title: 'TYPESCRIPT', image: '/skills/typescript.png', proficiency: 3 },
  { title: 'PYTHON', image: '/skills/python.png', proficiency: 3 },
  { title: 'REACT JS', image: '/skills/react.png', proficiency: 3 },
